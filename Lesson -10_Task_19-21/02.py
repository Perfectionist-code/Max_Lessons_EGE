...
print('19)', *(s for s in range(1, 51) if f(s, 2)))  # 13
print('20)', *(s for s in range(1, 51) if not f(s, 1) and f(s, 3)))  # 21 24
print('21)', *(s for s in range(1, 51) if not f(s, 2) and f(s, 4)))  # 20
